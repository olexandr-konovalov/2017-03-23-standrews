...
* Creating the array did not just create a matrix
* Information about the matrix was created, too
* The information is stored in *members* or *attributes* that belong to `data`
